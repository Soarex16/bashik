...
data class Environment(val variables: Map<String, String> = mapOf(), val parent: Environment?) {
    ...
    /**
     * Collects variables from all environments in hierarchy
     */
    ...
    private fun collectKeys(): Set<String> =
        if (parent == null) variables.keys else variables.keys + parent.collectKeys()
}
